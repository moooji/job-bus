...
const createSqsProducerAsync = Bluebird.promisify(SqsProducer.create, SqsProducer);
...
function Dispatcher(requestsUrl, region) {
  ...
  this.requestsProducer = SqsProducer.create({
...
Dispatcher.prototype.publishJob = function(job) {
  ...
  return new Bluebird((resolve, reject) => {
    ...
    this.requestsProducer.send([{id, body}], (err) => {
